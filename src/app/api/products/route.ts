...
export async function GET(request: Request) {
  ...
  try {
    ...
    // Post-process: voucher filtering, average rating, keyword prioritization, and JS sorting
    const keywordPriority = ['Spatial', '1.1', 'January 1', '2.2', 'February 2', '3.3', 'March 3', '4.4', 'April 4', '5.5', 'May 5', '6.6', 'June 6', '7.7', 'July 7', '8.8', 'August 8', '9.9', 'September 9', '10.10', 'October 10', '11.11', 'November 11', '12.12', 'December 12'];
    ...
    processedData.sort((a, b) => {
      if (a.has_priority !== b.has_priority) return b.has_priority ? 1 : -1;
      if (a.keyword_score !== b.keyword_score) return b.keyword_score - a.keyword_score;
      if ((a.voucher?.is_promo || false) !== (b.voucher?.is_promo || false)) return (b.voucher?.is_promo ? 1 : -1);
